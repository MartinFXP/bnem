...
## That is also why B-NEM requires the CNO R-package to run and still uses objects and some routines from CellNOptR. E.g. the CNOlist S4-class. But several function have been rewritten (simulateStatesRecursive function to simulate the steady state of a Boolean network or disjunctive normal form is completely new).
