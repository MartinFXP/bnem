...
for (n in rev(round(seq(10, 30, (30-10)/4)))) {
  ...
  for (c in 1:10) {
    ...
    ## NEMlist$exprs[noisy] <- 1 - NEMlist$exprs[noisy] # discrete noise
...
## save(CNOlist, CNOresults, CNOinput, file = "superpkn_nodes_cont.RData")
...
pdf("publications/BNEM/BCR_super_nodes.pdf", width = 5, height = 5)
