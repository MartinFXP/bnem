...
## 	/var/folders/2f/mtjcsd910hz9xnn3shkljg_8005f53/T//RtmpRcZHWh/downloaded_packages
\end{verbatim}
\begin{alltt}
\hlkwd{library}\hlstd{(devtools)}

\hlkwd{dev_mode}\hlstd{(}\hlkwc{on}\hlstd{=T)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Dev mode: ON}}\begin{alltt}
\hlkwd{install_github}\hlstd{(}\hlstr{"MartinFXP/bnem/package"}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Downloading GitHub repo MartinFXP/bnem@master\\\#\# from URL https://api.github.com/repos/MartinFXP/bnem/zipball/master}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# condition in stop(github\_error(request)): Not Found (404)}}\begin{alltt}
\hlkwd{dev_mode}\hlstd{(}\hlkwc{on}\hlstd{=F)}
\end{alltt}


{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Dev mode: OFF}}\begin{alltt}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# The following object is masked from 'package:ggplot2':\\\#\# \\\#\#\ \ \ \  layer}}\end{kframe}
...
##  [5] snow_0.4-1          matrixStats_0.50.2  bnem_1.0            nem_2.46.0         
...
## [11] jsonlite_1.0     evaluate_0.9     memoise_1.0.0    gtable_0.2.0     curl_1.2        
